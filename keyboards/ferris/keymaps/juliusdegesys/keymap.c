...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [NUM] = LAYOUT(
    KC_F8  , KC_F7 , KC_F6 , KC_F5, KC_HOME,    KC_PLUS, KC_7, KC_8, KC_9, KC_ASTR,
    KC_F4  , KC_F3 , KC_F2 , KC_F1, KC_END ,    KC_0   , KC_4, KC_5, KC_6, KC_BSPC,
    KC_F12,  KC_F11, KC_F10, KC_F9, XXXXXXX,    KC_MINS, KC_1, KC_2, KC_3, KC_SLSH,
