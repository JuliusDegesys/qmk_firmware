...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [SYM] = LAYOUT(
    ...
    KC_PIPE, KC_LCBR, KC_LBRC, KC_LPRN, KC_LT,      KC_GT  , KC_RPRN, KC_RBRC, KC_RCBR, XXXXXXX,
  ...
  [NUM] = LAYOUT(
    KC_F1  , KC_F2 , KC_F3 , KC_F4, _______,    KC_PLUS, KC_7, KC_8, KC_9, KC_ASTR,
    KC_F5  , KC_F6 , KC_F7 , KC_F8, _______,    KC_0   , KC_4, KC_5, KC_6, KC_BSPC,
    KC_F9  , KC_F10, KC_F11, KC_F12, _______,    KC_MINS, KC_1, KC_2, KC_3, KC_SLSH,
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    ...
    if (record->event.pressed) {
        uprintf("KD:%u:%u:%u:0x%04X:0x%02X:%lu\n",
